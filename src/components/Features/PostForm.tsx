...
const PostForm: React.FC<RequestFormProps> = ({ onClose, title }) => {
        ...
        {!showLetter ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Post Details */}
              <div className="mt-4">
                <p className="font-semibold mb-2">Post Details</p>
                <input
                  type="text"
                  name="postHeadline"
                  placeholder="Post headline / one line explanation"
                ...
                />
                <textarea
                  name="postFullContent"
                  placeholder="Provide full content of the post"
                  value={formData.postFullContent}
                  onChange={handleChange}
            ...
            {showLetter && (
              <>
                ...
                >
                  ...
                  <p className="mt-4 font-semibold">Post Details:</p>
                  <div className="ml-6 space-y-1">
                    <p><strong>Headline:</strong> {formData.postHeadline}</p>
                    <p><strong>Theme:</strong> {formData.postTheme}</p>
                    <p><strong>Full Content:</strong> {formData.postFullContent}</p>
                  </div>

                  <p className="mt-6">
                    We kindly request your approval and support for this post. Thank you for your consideration.
                  </p>
